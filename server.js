...
var database_1 = require("./dist/database");
var app = (0, express_1.default)();
var cors = require("cors");
var _a = require("express-validator"),
     checkSchema = _a.checkSchema,
...
routes_1.AppRoutes.forEach(function (route) {
     app.use(route.path, checkSchema(route.schema), function (req, res, next) {
                    ...
                    case 0:
                         return [
                              ...
                              app.listen(process.env.PORT || 8080, function () {
                                   console.log(
                                        "Server running on http://127.0.0.1:".concat(
                                             process.env.PORT
                                        )
                                   );
                              }),
